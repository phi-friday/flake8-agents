# spec-agent-guidance-governance Specification

## Purpose

Define how persistent OpenSpec requirements, agent guidance, and executable validation checks share ownership so repository policy remains current, discoverable, and non-duplicative.
