...
The anti-pattern flake8 rules capability SHALL be the canonical OpenSpec contract for AGT2xx dynamic anti-pattern diagnostics, including dynamic lookup, dynamic mutation, dynamic imports, construction bypasses, raw namespace access, dotted import aliases, and `types.SimpleNamespace` dynamic namespace use.
